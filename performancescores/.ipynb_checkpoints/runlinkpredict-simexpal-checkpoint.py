...
for tf in ltrainfrac:
    ...
    #print("Link predictions(Hadamard):", tf, ":Accuracy:",acc)
...
'''
# python3 ../../performancescores/runlinkpredict-simexpal.py ../../datasets/input/com-Youtube.mtx 1 com-Youtube.embd 128